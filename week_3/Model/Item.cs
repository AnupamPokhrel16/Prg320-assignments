...
{
    /// <summary>
    /// Abstract base class for library items. Demonstrates:
    /// ABSTRACTION: Common structure for Books and Magazines.
    /// ENCAPSULATION: Private fields with public property validation.
    /// INHERITANCE: Blueprint for derived classes.
    /// </summary>
    public abstract class Item
    {
        ...
        // VALIDATION: Title must be 5+ chars, auto-capitalizes. Virtual allows override.
        ...
        // VALIDATION: Publisher must be 6+ chars, auto-capitalizes. Virtual allows override.
        ...
        // POLYMORPHISM: Virtual method for polymorphic display behavior across derived types.
